...
function add_new(e) {
    ...
    if (e.key === "Enter") {
        ...
        input1.setAttribute('onClick','load_items(this)')
        input1.setAttribute('onchange','set_item(this)')
        ...
        input3.setAttribute('style', 'width:75%;float:left');
        ...
        document.getElementById('items_table').appendChild(pTr);
...
function sales_add_new(e) {
    ...
    if (e.key === "Enter") {
        ...
        input4.setAttribute('type', 'text')
        input4.setAttribute('class', 'form-control')
        input4.setAttribute('onkeyUp', 'calc(this)')
        ...
        input5.setAttribute('onkeyup', 'grand_total()')
        ...
        // tr.innerHTML = '<td>&nbsp;</td>';
        // document.getElementById('total_table').appendChild(tr);
        document.getElementById('items_table').appendChild(pTr);
